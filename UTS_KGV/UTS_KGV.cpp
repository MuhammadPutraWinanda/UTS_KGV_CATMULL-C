...
float color3[] = { 0.0f, 0.5f, 0.5f, 1.0f };
float color4[] = { 1.0f, 0.0f, 1.0f, 1.0f };
float color5[] = { 0.0f, 1.0f, 0.0f, 1.0f };
float color6[] = { 1.0f, 1.0f, 1.0f, 1.0f };
float color7[] = { 0.0f, 1.0f, 1.0f, 1.0f };
